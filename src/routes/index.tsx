  ...
  return <main className="overflow-hidden bg-background text-foreground">
    ...
    <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden bg-background px-5 pb-20 pt-28 text-center">
      <img src={facade.url} alt="Fachada de Home Wonder Safe" className="absolute inset-0 h-full w-full object-cover" />
       <div className="video-cover hidden md:block" aria-hidden="true"><iframe src="https://www.youtube.com/embed/ti-4VKrdXg0?autoplay=1&mute=1&loop=1&playlist=ti-4VKrdXg0&controls=0&showinfo=0&rel=0" title="Home Wonder Safe" allow="autoplay; encrypted-media" /></div>
      <div className="absolute inset-0 bg-background/70" />
      <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-background to-transparent" />
       <div className="relative z-10 mx-auto w-full max-w-7xl animate-fade-in"><p className="mb-7 text-[10px] font-bold uppercase tracking-[0.28em] text-cream md:text-xs">Edificio residencial exclusivo</p><h1 className="text-gold-gradient whitespace-nowrap font-display text-[clamp(2.15rem,8vw,7rem)] font-semibold leading-none">Home Wonder Safe</h1><p className="mt-7 text-lg text-cream md:text-2xl">Calidad, seguridad y diseño innovador</p><p className="mt-3 flex items-center justify-center gap-2 text-sm text-cream/80"><MapPin className="h-4 w-4 text-gold" /> Urb. Alpamayo · Ate</p><div className="mx-auto mt-7 inline-flex items-center gap-3 border border-gold/40 bg-background/55 px-4 py-3 text-xs font-semibold uppercase tracking-[0.12em] text-cream backdrop-blur"><span className="soft-pulse h-2 w-2 rounded-full bg-gold" /> Preventa abierta · Entrega diciembre 2026</div><div className="mt-8"><Button asChild variant="gold" size="lg" className="h-14 px-10 text-sm uppercase"><a href="#contacto">Quiero conocer el precio <ArrowRight /></a></Button></div></div>
    ...
    <section id="propuesta" className="px-5 py-24 md:px-10 md:py-32"><div className="mx-auto w-full max-w-7xl"><SectionHeading number="02" eyebrow="Una nueva forma de vivir" title="Home Wonder Safe" /><p className="reveal mx-auto mb-14 max-w-3xl text-center font-display text-2xl leading-relaxed text-cream md:text-3xl">Un hogar donde la privacidad no es un lujo, sino parte de cada día. Espacio, seguridad e independencia en un entorno moderno y cerrado.</p><div className="grid gap-px bg-gold/30 md:grid-cols-3">{[
    ...
    <section className="bg-night-soft px-5 py-24 md:px-10 md:py-32"><div className="mx-auto w-full max-w-7xl"><SectionHeading number="03" eyebrow="Ubicación" title="Todo cerca. La tranquilidad, aún más." /><div className="grid min-w-0 items-stretch gap-10 lg:grid-cols-[minmax(0,.9fr)_minmax(0,1.1fr)]"><div className="reveal min-w-0"><div className="bg-gold-gradient px-6 py-5 font-extrabold tracking-wide text-primary-foreground md:px-8">Calle Montaña de Asturias Mz. M Lote 29 — Urb. Alpamayo, Ate</div><div className="mt-8 space-y-8">{[
    ...
    <section className="px-5 py-24 md:px-10 md:py-32"><div className="mx-auto w-full max-w-7xl"><SectionHeading number="04" eyebrow="Distribución & tipologías" title="Privacidad absoluta" subtitle="Solo 1 departamento por piso. Cinco familias en todo el edificio." /><div className="grid min-w-0 gap-10 lg:grid-cols-2"><div className="grid min-w-0 gap-5">{[
    ...
    ].map((item) => <article key={item[0]} className="reveal min-w-0 border border-gold/30 bg-night-soft p-7 md:p-9"><div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-5"><h3 className="min-w-0 text-3xl text-cream">{item[0]}</h3><span className="shrink-0 font-display text-3xl text-gold">{item[1]}</span></div><div className="my-6 h-px bg-gold/20" /><p className="flex gap-3 text-muted-foreground"><Check className="h-5 w-5 shrink-0 text-gold" />{item[2]}</p><p className="mt-3 flex gap-3 text-muted-foreground"><Check className="h-5 w-5 shrink-0 text-gold" />{item[3]}</p></article>)}</div><figure className="reveal grid min-w-0 grid-cols-2 gap-3"><img src={bedroom.url} loading="lazy" alt="Dormitorio principal iluminado de Home Wonder Safe" className="col-span-2 aspect-[16/10] h-full w-full object-cover transition duration-700 hover:scale-[1.01]" /><img src={bedroomTwo.url} loading="lazy" alt="Dormitorio doble de Home Wonder Safe" className="aspect-square h-full w-full object-cover" /><img src={bedroomThree.url} loading="lazy" alt="Dormitorio individual de Home Wonder Safe" className="aspect-square h-full w-full object-cover" /><figcaption className="col-span-2 text-xs uppercase tracking-[0.15em] text-muted-foreground">Dormitorios amplios e iluminados</figcaption></figure></div></div></section>

    <section className="bg-night-soft px-5 py-24 md:px-10 md:py-32"><div className="mx-auto w-full max-w-7xl"><SectionHeading number="05" eyebrow="Interiores" title="Un hogar diseñado para enamorar a primera vista" />{[
      { title: "Espaciosa Sala-Comedor", text: "Concepto de ambiente integrado pensado para la vida familiar, con excelente ingreso de luz natural y ventilación cruzada.", images: [living, dining] },
       { title: "Cocina & Lavandería", text: "Acabados de calidad, espacio optimizado para centro de lavado e instalación de gas natural.", images: [kitchen, kitchenWide] },
    ...
    <section className="px-5 py-24 md:px-10 md:py-32"><div className="mx-auto w-full max-w-7xl"><SectionHeading number="06" eyebrow="Recorrido 3D" title="Recorre el proyecto en 3D" subtitle="Conoce cada detalle del edificio y visualiza cómo será tu próximo hogar." /><div className="reveal aspect-video w-full overflow-hidden border border-gold/30 bg-night-soft shadow-2xl"><iframe className="h-full w-full" src="https://www.youtube.com/embed/ti-4VKrdXg0?controls=1&rel=0" title="Recorrido 3D de Home Wonder Safe" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen /></div></div></section>

    <section className="bg-night-soft px-5 py-24 md:px-10 md:py-32"><div className="mx-auto w-full max-w-7xl"><SectionHeading number="07" eyebrow="Equipamiento" title="Comodidad y estilo de vida superior" /><div className="grid min-w-0 gap-8">{[
      { Icon: Building2, title: "Accesibilidad & Elevación", text: "Ascensor con capacidad para 6 personas. Plataforma de accesibilidad desde la entrada hasta el Piso 1.", image: elevator, alt: "Ascensor de Home Wonder Safe" },
    ...
    ].map(({ Icon, title, text, image, alt }, index) => <article key={title} className="reveal grid min-w-0 overflow-hidden border border-gold/30 bg-background md:grid-cols-2"><img src={image.url} loading="lazy" alt={alt} className={`aspect-[16/10] h-full min-h-72 w-full object-cover ${index % 2 ? "md:order-2" : ""}`} /><div className={`flex min-w-0 flex-col justify-center p-8 md:p-12 ${index % 2 ? "md:order-1" : ""}`}><Icon className="mb-6 h-8 w-8 text-gold" /><h3 className="text-2xl text-cream">{title}</h3><p className="mt-4 leading-7 text-muted-foreground">{text}</p></div></article>)}</div></div></section>

    <section className="border-y border-gold/20 px-5 py-24 md:px-10 md:py-32"><div className="mx-auto w-full max-w-7xl"><SectionHeading number="08" eyebrow="Respaldo técnico e ingeniería" title="Construido para durar" /><div className="grid gap-px bg-gold/30 md:grid-cols-2"><article className="reveal bg-night-soft p-8 md:p-12"><Construction className="mb-7 h-10 w-10 text-gold" /><h3 className="text-3xl text-cream">Estructura Antisísmica</h3><p className="mt-5 leading-8 text-muted-foreground">Placas de concreto, vigas de cimentación, zapatas y columnas conforman una estructura de alta resistencia.</p></article><article className="reveal bg-night-soft p-8 md:p-12"><Wrench className="mb-7 h-10 w-10 text-gold" /><h3 className="text-3xl text-cream">Materiales de Calidad</h3><p className="mt-5 leading-8 text-muted-foreground">Cementos Sol, Fierros Sider, Tuberías Pavco y Ladrillos Forte: marcas líderes seleccionadas para durar.</p></article></div></div></section>
