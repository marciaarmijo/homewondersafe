...
function HomePage() {
  ...
  return <main className="overflow-hidden bg-background text-foreground">
    ...
    <section className="px-5 py-20 sm:px-8 md:px-10 md:py-28"><div className="mx-auto w-full max-w-7xl min-w-0"><SectionHeading number="04" eyebrow={<>Distribución <Ampersand /> tipologías</>} title="Privacidad absoluta" subtitle="Solo 1 departamento por piso. Cinco familias en todo el edificio." /><div className="grid min-w-0 items-stretch gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,34rem)]"><div className="grid min-w-0 gap-5">{[
      ["Piso 1", "103 m²", "2 dormitorios amplios e iluminados", "2 baños completos"], ["Pisos 2 al 5", "121 m²", "3 dormitorios amplios e iluminados", "2 ½ baños · Dormitorio principal con baño privado"],
    ].map((item) => <article key={item[0]} className="reveal min-w-0 border border-gold/30 bg-night-soft p-6 sm:p-7 md:p-8"><div className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-4"><h3 className="min-w-0 text-2xl text-cream lg:text-3xl">{item[0]}</h3><span className="numeric shrink-0 font-display text-2xl text-gold lg:text-3xl">{item[1]}</span></div><div className="my-6 h-px bg-gold/20" /><p className="flex gap-3 text-sm leading-7 text-muted-foreground sm:text-base"><Check className="h-5 w-5 shrink-0 text-gold" />{item[2]}</p><p className="mt-3 flex gap-3 text-sm leading-7 text-muted-foreground sm:text-base"><Check className="h-5 w-5 shrink-0 text-gold" />{item[3]}</p></article>)}</div><figure className="reveal mx-auto grid w-full max-w-[29rem] min-w-0 grid-cols-2 grid-rows-2 gap-3 lg:h-full lg:max-w-none lg:self-stretch"><img src={bedroom.url} loading="lazy" alt="Dormitorio principal iluminado de Home Wonder Safe" className="h-40 w-full object-cover transition duration-700 hover:scale-[1.01] sm:h-48 lg:h-full lg:min-h-0" /><img src="/habitacion1_1.png" loading="lazy" alt="Otro ángulo del dormitorio principal de Home Wonder Safe" className="h-40 w-full object-cover transition duration-700 hover:scale-[1.01] sm:h-48 lg:h-full lg:min-h-0" /><img src={bedroomTwo.url} loading="lazy" alt="Dormitorio doble de Home Wonder Safe" className="h-40 w-full object-cover sm:h-48 lg:h-full lg:min-h-0" /><img src={bedroomThree.url} loading="lazy" alt="Dormitorio individual de Home Wonder Safe" className="h-40 w-full object-cover sm:h-48 lg:h-full lg:min-h-0" /></figure></div></div></section>
